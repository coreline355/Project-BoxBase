...
| ----------------------------------------- | -------------- | ------------ | ----------------- | ------------- | ------------------------- |
| 11 Red Velvet Cake (Kernel Version 5.4.x) | Amlogic S905X4 | 16 GB & 2 GB | ✅                 | ✅             | ✅ (Needs External App)    |
...
- Base system and apps is similar to UniTV S1 and HTV H9 (Including the IPTV Player)
